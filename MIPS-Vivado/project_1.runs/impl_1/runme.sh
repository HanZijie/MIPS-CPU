...
HD_PWD='C:/Users/Jason/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipelining.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipelining.tcl -notrace
